      ...
      >
        ...
        <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
          ...
          >
            ...
            >
             <StyledLink target={"_blank"} > FREE </StyledLink>Bored Valentines NFT Giveaway
            </s.TextTitle>          
            <s.TextDescription
              style={{
                textAlign: "center",
            ...
            >
            Complete 3 simple tasks to get a FREE Bored Valentines NFT.
              
           <s.SpacerXSmall/>
               <StyledLink target={"_blank"} href="https://gleam.io/w1YyY/free-bored-valentines-club-nft-giveaway">
                  Click Here
                </StyledLink>     
              </s.TextDescription>
              <s.TextDescription
            ...
            >
              ...
              <StyledLink target={"_blank"} href="https://twitter.com/BoredValentines"> <StyledLogoXSmall src={"/config/images/Twitter.png"} /></StyledLink>
              <span>                                                </span>
              <StyledLink target={"_blank"} href="https://discord.gg/STByPkf2V2"><StyledLogoXSmall src={"/config/images/Discord.png"} /></StyledLink>
              <span>                                                     </span>
              <StyledLink target={"_blank"} href="https://www.instagram.com/boredvalentinesclub_nft/"><StyledLogoXSmall src={"/config/images/IG.png"} /></StyledLink>
            ...
            >
              Public Sale: March 14, 2022, UTC 00:00:00 (PST) 
            </s.TextDescription>
{/*}
      no need button here
              <StyledButton
 ...
 BV Dating Club is essentially a blockchain-based social dating community that offers key elements missing from current dating app, like trust, transparency, data security and fraud protection against nefarious actors, or ‘catfishes.
        ...
        <s.SpacerLarge />
        <s.Container flex={1} jc={"center"} ai={"center"}>
            <StyledImgHsq alt={"example"} src={"/config/images/Teaser.png"}/>
            {/* style={{ transform: "scaleX(-1)" }} */}
          </s.Container>
...
Lex, the Utility Manager, will be managing the utility of the NFT, like the BV Dating Club & the Mating Room.
      ...
      <s.Container         image={"/config/images/bg-pink.png"} >
        <s.Container
          jc={"right"} ai={"right"} 
          ...
          style={{marginLeft:"-55px",
            ...
            >
          By Team CurlyBear              
              <StyledLogoXSmall src={"/config/images/CurlyBear.png"}  />
            </s.TextDescription>
          </s.Container>
        </s.Container>
    </s.Screen>
